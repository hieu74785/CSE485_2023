...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 24, 2024 lúc 11:05 AM
...
-- Thủ tục
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_DSBaiViet` (IN `tenTheLoai` VARCHAR(255))   BEGIN
...
(1, '1', '1', 'user', '2024-09-19 18:53:51'),
(2, '2', '$2y$10$T6P/zY.RCikdkTqENKzwmebH/0LX88c8W6LzGdMIAe76rM3FlJ4Wu', 'user', '2024-09-23 14:32:50');
...
--
ALTER TABLE `tacgia`
  MODIFY `ma_tgia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT cho bảng `theloai`
--
ALTER TABLE `theloai`
  MODIFY `ma_tloai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
